...
export function SiteHeader() {
  ...
  return (
    <header className="flex h-(--header-height) shrink-0 items-center gap-2 border-b border-border bg-background/95 transition-[width,height] ease-linear supports-backdrop-filter:backdrop-blur group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
      <div className="flex w-full items-center gap-1 px-4 lg:gap-2 lg:px-6">
        ...
        />
        <h1 className="text-base font-medium">Explore Map</h1>
